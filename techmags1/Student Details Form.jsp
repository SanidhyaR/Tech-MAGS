...
<!-- <img src="background.gif" style="width: 100%;height: 100%;" > -->
 <h1 style="margin-top:20px;text-align:center;">Please Enter Your Details</h1>
 
 <div class="container">
 <form action="connectprof">
 			...
 			<table>
 				<tbody><tr>
 					...
 					<td class="table_data"><input type="text" placeholder="First Name" class="input_box" name="first_name" required></td>
 ...
 <h3 style="margin-top:50px;margin-bottom:20px;">Upload Documents</h3>	
 			<table>
 				<tbody><tr>
 					<td class="table_data"><label class="input_label" for="cand_photol">Upload Photo </label></td>
 					<td class="table_data"><input type="file" class="input_box" name="cand_photo"></td>

 					<td class="table_data"><label class="input_label" for="cand_signature">Upload Signature </label></td>
 					<td class="table_data"><input type="file" class="input_box" name="cand_signature"></td>
 				</tr>
 				<tr>
 					<td class="table_data"><label class="input_label" for="coll_marksheet">Upload Final year mark sheet  </label></td>
 					<td class="table_data"><input type="file" class="input_box" name="coll_marksheet"></td>

 					<td class="table_data"><label class="input_label" for="cand_resume">Upload Resume</label></td>
 				...
 				<tr>
 					...
 					<td class="table_data"><label class="input_label" for="cover_letter">Upload Cover Letter</label></td>
 					<td class="table_data"><input type="file" class="input_box" name="cover_letter"></td>
 				</tr>
 				<tr>
 					<td class="table_data"><label class="input_label" for="transcript">Upload Transcript </label></td>
 			...
 			<a href="fourthpage.jsp" class="btn btn-primary btn-lg active" role="button" aria-pressed="true" style="margin-left:530px;margin-top:50px; margin-bottom:70px;">Submit </a>
 			</form>
 			</div>
