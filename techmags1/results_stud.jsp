		...
		<div class="container" style="margin-top: 4%;">
			<table>
	 		...
	 		<div class="card" style="width: 20rem;">
	  			<img src="images/university1.jpeg" class="card-img-top" alt="..." style="height: 22.4rem;">
	  			<div class="card-body">
	  				<h4 style="text-align: center;">University of California</h4>
	 		...
	 		<div class="card" style="width: 20rem;  margin-left: 70px; " >
	  			<img src="images/university8.jpg" class="card-img-top" alt="..." style="height: 22.4rem;">
	  			<div class="card-body">
	  				<h4 style="text-align: center;">Duke University</h4>
	  				<div class="card-text" style="text-align:center;">
				...
				<td>
	 		<div class="card" style="width: 20rem;  margin-left: 70px;" >
	  			<img src="images/university5.jpg" class="card-img-top" alt="..." style="height: 22.4rem;">
	  			<div class="card-body">
	  				<h4 style="text-align: center;">University of Michigan</h4>
	  				<div class="card-text" style="text-align:center;">
