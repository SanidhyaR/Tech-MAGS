    ...
    <h1 class="logo"><a href="index.jsp" style="text-decoration: none; color: white;  font-size: 25px;">Techmags</a></h1>
      <ul class="main-nav">
          ...
          <!--  <li><a href="profile.jsp" style="text-decoration: none; color: white; ">Profile</a></li>-->
            ...
            <div id = "content">
                <div id = "one">
                    <a href="secondpage.jsp" class="btn btn-danger btn-lg active" role="button" aria-pressed="true">New Job</a>
                </div>

                <div id = "two">
                    <a href="results.jsp" class="btn btn-danger btn-lg active" role="button" aria-pressed="true">Job Status</a>

                </div>

            </div>
            <div class="container">
               <a href="secondpage.jsp"> <img src="images/job.png" class="img"></a>
               <a href="results.jsp" > <img src="images/result.png" class="img" style="width:30%;"></a>
            </div>
